"""
CUTEst pre-registration protocol v1.1.

Amendment:
18 small + 22 medium + 10 large = 50 problems.
The amendment was made solely because strict technical screening
found only 18 valid small problems, before optimizer performance
was evaluated.
"""
...
candidate_pool_path = (
    PROTOCOL_DIR
    / "cutest_candidate_pool_v1_1.csv"
)
...
selected_path = (
    PROTOCOL_DIR
    / "cutest_pre_registered_problem_list_v1_1.csv"
)

excluded_path = (
    PROTOCOL_DIR
    / "cutest_technical_exclusions_v1_1.csv"
)
...
protocol_text = f"""# BasinGraph CUTEst pre-registration protocol v1.1
...
- small: 2–20 variables, target 18 problems;
- medium: 21–100 variables, target 22 problems;
- large: 101–500 variables, target 10 problems.

Total target: 50 problems.

## Protocol amendment from v1 to v1.1

The original performance-blind target allocation was 20 small,
20 medium and 10 large problems. Before any optimizer-performance
experiment was executed, technical screening established that only
18 small fixed-dimensional problems satisfied all predefined
requirements, including finite box bounds, continuous variables,
a feasible CUTEst initial point and a finite initial objective value.

The two unavailable small-problem slots were therefore reassigned
to the medium-dimensional stratum. The revised allocation is
18 small, 22 medium and 10 large problems, preserving the total
pre-registered benchmark size of 50. No optimizer result was used
in this amendment.
...
protocol_path = (
    PROTOCOL_DIR
    / "CUTEST_PRE_REGISTRATION_PROTOCOL_v1_1.md"
)
...
manifest_path = (
    PROTOCOL_DIR
    / "CUTEST_PRE_REGISTRATION_MANIFEST_v1_1.csv"
)
...
smoke_path = (
    RESULT_DIR
    / "cutest_unified_runner_smoke_v1_1.csv"
)
...
summary_path = (
    PROTOCOL_DIR
    / "CUTEST_PRE_REGISTRATION_SUMMARY_v1_1.json"
)
