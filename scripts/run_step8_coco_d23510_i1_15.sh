...
RUN_ID=step8_coco_d23510_f1_24_i1_15_$(date +%Y%m%d_%H%M%S)
echo "${RUN_ID}" | tee official_results/STEP8_LAST_RUN_ID.txt

echo "============================================================"
echo "Step 8 official COCO/BBOB subset"
echo "RUN_ID: ${RUN_ID}"
echo "Dimensions: 2,3,5,10"
echo "Functions: 1-24"
echo "Instances: 1-15"
