...
RUN_ID=step9_coco_d2351020_f1_24_i1_15_$(date +%Y%m%d_%H%M%S)
echo "${RUN_ID}" | tee official_results/STEP9_LAST_RUN_ID.txt

echo "============================================================"
echo "Step 9 official COCO/BBOB main validation"
echo "RUN_ID: ${RUN_ID}"
