...
RUN_ID=step7a_coco_d235_f1_24_i1_5_$(date +%Y%m%d_%H%M%S)
echo "${RUN_ID}" | tee official_results/STEP7A_LAST_RUN_ID.txt

echo "============================================================"
echo "Step 7A official COCO/BBOB medium subset"
echo "RUN_ID: ${RUN_ID}"
